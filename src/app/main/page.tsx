...
import { Video, Plus, Users, ChartBar as BarChart3, FileText, Calendar, Clock, Loader2, Eye, Settings, LogOut, Copy, ExternalLink, TrendingUp, Award, Target, Bell, Search, Filter, MoveHorizontal as MoreHorizontal, ArrowUpRight, Zap, Shield, Globe, ArrowLeft, UserPlus, Building2 } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const hasNoOrganizations = (!ownOrganizations || ownOrganizations.length === 0) && 
          ...
          <div className="flex items-center justify-center py-20">
            <div className="text-center max-w-2xl">
              <div className="mb-8 flex justify-center">
                <div className="w-32 h-32 bg-gradient-to-br from-royal-blue/10 to-deep-wine/10 rounded-3xl flex items-center justify-center">
                  <Building2 className="w-16 h-16 text-royal-blue" />
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  className="bg-gradient-to-r from-royal-blue to-deep-wine hover:from-deep-wine hover:to-royal-blue text-white px-8 py-6 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group"
                  onClick={() => window.location.href = '/create-organization'}
                >
                ...
                <Button
                  className="bg-white hover:bg-alice-white text-royal-blue border-2 border-royal-blue px-8 py-6 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group"
                  onClick={() => window.location.href = '/join-organization'}
                >
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-6 card-shadow border border-white/50">
                  ...
                  {upcoming && upcoming.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <Calendar className="w-12 h-12 text-onyx-gray/30 mx-auto mb-3" />
