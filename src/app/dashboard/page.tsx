...
import { Video, Plus, Users, ChartBar as BarChart3,Share, FileText, Calendar, Clock, Eye, Settings, LogOut, Copy, ExternalLink, TrendingUp, Award, Target, Bell, Search, Filter, MoveHorizontal as MoreHorizontal, ArrowUpRight, Zap, Shield, Globe, ArrowLeft, CalendarPlus } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4">
              ...
              {organizationCode && (
                <div className="relative">
                  ...
                  >
                    <Share className="w-4 h-4 mr-2 group-hover:rotate-90 transition-transform duration-300" />
                    Code
                  </Button>
              ...
              <div className="text-center max-w-2xl">
                <div className="mb-8 flex justify-center">
                  <div className="w-32 h-32 bg-gradient-to-br from-royal-blue/10 to-deep-wine/10 rounded-3xl flex items-center justify-center">
                    <CalendarPlus className="w-16 h-16 text-royal-blue" />
                  </div>
                </div>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-alice-white/50">
                          ...
                          {isAdmin && <th className="text-left py-5 px-6 text-sm font-bold text-rich-black uppercase tracking-wider">Action</th>}
                        </tr>
                      </thead>
                      <tbody>
                        {meetings.map((meet) => (
